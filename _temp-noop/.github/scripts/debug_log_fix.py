...
search = apply(search, 'book, chapter, false, source', "    await app.loadPassage(book, chapter);", "    await app.loadPassage(book, chapter, false, source);", 'reference load source call')
...
auth = apply(auth, "'legacy-saved-position-no-user'", "        await app.loadPassage(app.state.currentBook, app.state.currentChapter);", "        await app.loadPassage(app.state.currentBook, app.state.currentChapter, false, 'legacy-saved-position-no-user');", 'legacy no user source')
auth = apply(auth, "!!app.lastScrollPosition, 'legacy-saved-position'", "    await app.loadPassage(app.state.currentBook, app.state.currentChapter, !!app.lastScrollPosition);", "    await app.loadPassage(app.state.currentBook, app.state.currentChapter, !!app.lastScrollPosition, 'legacy-saved-position');", 'legacy saved position source')
write('auth.js', auth)
