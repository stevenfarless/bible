...
//
// Output: console table + exits with code 1 if any issues found.
...
// Canonical Protestant Bible: book name -> array of verse counts per chapter
// Index 0 = chapter 1, index 1 = chapter 2, etc.
const CANON = {
    'Genesis':          [31,25,24,26,32,22,24,22,29,32,32,20,18,24,21,16,27,33,38,18,34,24,20,67,34,35,46,22,35,43,55,32,20,31,29,43,36,30,23,23,57,38,34,34,28,34,31,22,33,26],
    'Exodus':           [22,25,22,31,23,30,25,32,35,29,10,51,22,31,27,36,16,27,25,26,36,31,33,18,40,37,21,43,46,38,18,35,23,35,35,38,29,31,43,38],
    'Leviticus':        [17,16,17,35,19,30,38,36,24,20,47,8,59,57,33,34,16,30,24,16,15,18,21,20,15,20,15,22,26,18],
    ...
    'Esther':           [22,28,23,31,29,41,26,26,20,13,25,20],
    ...
    for (const [book, chapters] of Object.entries(CANON)) {
        ...
        for (let ch = 1; ch <= chapters.length; ch++) {
            ...
            for (let v = 1; v <= expectedVerses; v++) {
                ...
                } else if (!String(chapterData[String(v)]).trim()) {
